...
function renderTopbar() {
  ...
  const t = ts.toLocaleTimeString('en-US', {
    hour: '2-digit',
    minute: '2-digit',
    hour12: true
  });
  document.getElementById('topbar').innerHTML = `
    ...
    <div class="top-center">
      ${['world', 'americas', 'europe', 'middleEast', 'asiaPacific', 'africa'].map(r => `<button class="region-btn ${r === 'world' ? 'active' : ''}" data-region="${r}" onclick="setRegion('${r}')">${r === 'middleEast' ? 'MIDDLE EAST' : r === 'asiaPacific' ? 'ASIA PACIFIC' : r.toUpperCase()}</button>`).join('')}
    </div>
    <div class="top-right">
      ...
      ${(_D$delta = D.delta) !== null && _D$delta !== void 0 && _D$delta.summary ? `<span class="meta-pill">DELTA <span class="v">${D.delta.summary.direction === 'risk-off' ? '&#x25B2; RISK-OFF' : D.delta.summary.direction === 'risk-on' ? '&#x25BC; RISK-ON' : '&#x25C6; MIXED'}</span></span>` : ''}
...
function renderLeftRail() {
  ...
  const layers = [{
    ...
    count: totalAir,
    dot: 'air',
    sub: `${D.air.length} theaters`
  }, {
    name: 'Thermal Spikes',
    count: totalThermal.toLocaleString(),
    dot: 'thermal',
    sub: `${totalNight.toLocaleString()} night det.`
  }, {
    name: 'SDR Coverage',
    count: D.sdr.total,
    dot: 'sdr',
    sub: `${D.sdr.online} online`
  }, {
    name: 'Maritime Watch',
    ...
    dot: 'thermal',
    sub: `${conflictFatal.toLocaleString()} fatalities`
  }, {
    name: 'Health Watch',
    count: D.who.length,
    dot: 'health',
    ...
    count: D.tg.posts,
    dot: 'incident',
    sub: `${D.tg.urgent.length} urgent`
  }, {
    name: 'Satellites',
    count: ((_D$space = D.space) === null || _D$space === void 0 ? void 0 : _D$space.militarySats) || 0,
    dot: 'space',
    sub: `${((_D$space2 = D.space) === null || _D$space2 === void 0 ? void 0 : _D$space2.totalNewObjects) || 0} new (30d)`
  }];
  ...
  document.getElementById('leftRail').innerHTML = `
    ...
    <div class="g-panel">
      ...
      <div class="econ-row"><span class="elabel">VIX (Fear)</span><span class="eval" style="color:${(vix === null || vix === void 0 ? void 0 : vix.value) > 20 ? 'var(--warn)' : 'var(--accent)'}">${(vix === null || vix === void 0 ? void 0 : vix.value) || '--'}</span></div>
      <div class="econ-row"><span class="elabel">HY Spread</span><span class="eval">${(hy === null || hy === void 0 ? void 0 : hy.value) || '--'}</span></div>
      <div class="econ-row"><span class="elabel">USD Index</span><span class="eval">${(usd === null || usd === void 0 || (_usd$value = usd.value) === null || _usd$value === void 0 ? void 0 : _usd$value.toFixed(1)) || '--'}</span></div>
      <div class="econ-row"><span class="elabel">Jobless Claims</span><span class="eval">${(claims === null || claims === void 0 || (_claims$value = claims.value) === null || _claims$value === void 0 ? void 0 : _claims$value.toLocaleString()) || '--'}</span></div>
      <div class="econ-row"><span class="elabel">30Y Mortgage</span><span class="eval">${(mort === null || mort === void 0 ? void 0 : mort.value) || '--'}%</span></div>
      <div class="econ-row"><span class="elabel">M2 Supply</span><span class="eval">$${((_ref = (m2 === null || m2 === void 0 ? void 0 : m2.value) / 1000) === null || _ref === void 0 ? void 0 : _ref.toFixed(1)) || '--'}T</span></div>
...
function renderLower() {
  var _cpi$momChangePct, _delta$signals, _delta$signals2, _delta$signals3;
...
function runBoot() {
  ...
  const lines = [{
    text: 'INITIALIZING CRUCIX ENGINE v2.1.0',
    delay: 0
  }, {
    text: `CONNECTING ${D.meta.sourcesQueried} OSINT SOURCES...`,
    delay: 400
  }, {
    text: '&#9500;&#9472; OPENSKY &#183; FIRMS &#183; KIWISDR &#183; MARITIME',
    delay: 700
  }, {
    text: '&#9500;&#9472; FRED &#183; BLS &#183; EIA &#183; TREASURY &#183; GSCPI',
    delay: 900
  }, {
    text: '&#9500;&#9472; TELEGRAM &#183; SAFECAST &#183; EPA &#183; WHO &#183; OFAC',
    delay: 1100
  }, {
    text: '&#9492;&#9472; GDELT &#183; NOAA &#183; PATENTS &#183; BLUESKY &#183; REDDIT',
    delay: 1300
  }, {
    text: `SWEEP COMPLETE &#8212; <span class="count">${D.meta.sourcesOk}/${D.meta.sourcesQueried}</span> SOURCES <span class="ok">OK</span>`,
    delay: 1700
  }, {
    text: `ACLED CONFLICT LAYER: ${acledStatus}`,
    delay: 1900
  }, {
    text: 'FLIGHT CORRIDORS: <span class="ok">ACTIVE</span> &#183; DUAL PROJECTION: <span class="ok">READY</span>',
    delay: 2100
  }, {
    text: 'INTELLIGENCE SYNTHESIS: <span class="ok">ACTIVE</span>',
    delay: 2400
  }];
