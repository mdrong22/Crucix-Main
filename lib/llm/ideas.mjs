 ...
 */
export async function generateLLMIdeas(provider, sweepData, delta, previousIdeas = [], userPortfolio, accountOrders) {
...
export async function runPortfolioBrief(provider, sweepData, delta, previousIdeas = [], userPortfolio, accountOrders) {
   if (!provider?.isConfigured) return null;
