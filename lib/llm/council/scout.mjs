...
═══════════════════════════════════════════════════
  ...
  - ROTATION RULE: If Buying Power is low, scan ${userPortfolio} for "Weakest Link".
    Only propose a rotation if the new opportunity scores ≥ 5 pts AND clearly outperforms the weakest holding.
    Do NOT rotate for marginal scores (4 pts or below) — hold cash or stand down instead.
...
═══════════════════════════════════════════════════
  ...
  - 3-4 open positions → Elevated threshold. Only escalate if score ≥ 7 pts OR this is a rotation SELL (closing a loser).
  ...
  - If proposing a rotation, new opportunity must score ≥ 7 pts AND clearly outperform the weakest holding.
