...
export class ScoutLLM extends CouncilAgent {
    ...
    async assessInfo(context, currentData, userPort, lastDecision, buyingPower, openAccOrders) {
        ...
        1. PORTFOLIO & ORDER DEFENSE:
           ...
           - CHECK OPEN ORDERS: ${openAccountOrders ?? 'NONE'}. 
        ...
        - **Scout's Note:** [Why this ticker? Why sell the Rotation_Target now? Cite specific %, bars, and momentum tags provided in live data. Acknowledge ${openAccountOrders} if it blocked a previous target.]`;
        try {
