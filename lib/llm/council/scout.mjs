...
export class ScoutLLM extends CouncilAgent {
    ...
    async assessInfo(context, currentData, userPortfolio, userAccountHoldings, lastDecision) {
        ...
        const sysPrompt = `**Role:** You are the Market Scout named "Beta" for a high-frequency trading system. 
            **Objective:** Monitor real-time feeds and broader market sentiment while giving ideas to the council. Filter out 90% of the noise. Only escalate to the Council if a "Volatility Event" or a "Leverageable Idea" occurs. use web.
            **Input Data Points:**
            ...
            If you have reached out to the council before with the same idea or if info has not changed, respond "STATUS: QUIET. No escalation required." 
            last reached out:  
