...
═══════════════════════════════════════════════════
  Stand down if: No target scores ≥ 3 pts total OR Remaining Trades = 0 and no safe SWING/LONG setup exists OR all viable targets have existing OPEN_ORDERS.
  If proposing a rotation, stand down unless the new opportunity scores ≥ 5 pts.
