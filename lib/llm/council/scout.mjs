...
ANTI-BIAS RULE: Do NOT default to Boeing (BA) or any single ticker repeatedly.
...
and (c) portfolio fit. If BA appears again, it must meet ALL three criteria independently.
