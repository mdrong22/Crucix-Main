...
Keep in mind that during extended hours (4:00 PM - 8:00 PM EST) (4:00 AM - 9:30 AM EST) You cannot use "notional_value" or fractional decimals (e.g. 0.5). If you cannot afford a share of the stock during this time with our buying power ${buyingPower} go into Quiet Mode
Current time: ${new Date().toISOString()} (UTC). Remember Market Hours are EST (UTC-5/4)
...
5. EXTENDED HOURS CONSTRAINT: 
If current time is 4:00 PM - 8:00 PM EST or 4:00 AM - 9:30 AM EST:
- You are FORBIDDEN from suggesting a ticker if (Buying Power / Price) < 1.
- You MUST ensure the ticker is eligible for Extended Trading (No OTC/Pink Sheets).
- If no affordable whole-share opportunities exist, enter Quiet Mode.
