 ...
 *  Cerebras   — 30 RPM / 1M TPD  — llama-3.3-70b            — api.cerebras.ai/v1
 ...
 *
 * VERIFIED MODEL ID STRINGS (case-sensitive — wrong ID = 404):
 *  Cerebras:   llama-3.3-70b            ← NOT llama-3.3-70b-instruct
...
export const PROVIDERS = {
  cerebras: {
    ...
    model:   'llama-3.3-70b',             // ← no "-instruct" suffix on Cerebras
