...
export class GregorLLM extends CouncilAgent {
    ...
    async assessInfo(sysPrompts, conversation, buyingPower, totalValue, orders24h, vix = 'N/A', openAccountOrders) {
        ...
        6. Sell Constraints: If "order_type" is "Limit" (required for EXTENDED sessions), you CANNOT use "notional_value". You MUST calculate and provide "units" based on the "Current Positions" and set "notional_value" to null.
