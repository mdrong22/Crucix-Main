...
export class SnapTrade {
    constructor(config) {
        ...
        // ── Short-lived read cache — coalesces the overlapping account fetches (proposal cycle +
        // dashboard + stop-loss watcher) that were tripping SnapTrade's rate limit (429s). ──
