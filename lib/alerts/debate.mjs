...
export class Debate {
  ...
  async beginDebate(briefing, context) {
    ...
    const verdictInstruction = [
      ...
      `CRITICAL RULES:`,
      `1. If trading during EXTENDED hours (4:00 PM - 8:00 PM EST) (4:00 AM - 9:30 AM EST), you MUST use order_type: "Limit" and provide a price, and time_in_force: "Day". Current Time ${estTime} EST`,
