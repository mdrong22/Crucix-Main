...
export class Debate {
  ...
  async beginDebate(briefing) {
    ...
    const [portfolio, accountHoldings, accountBalance] = Promise.all([this.snapTradeInstance.FetchUserTrades(), this.snapTradeInstance.getBuyDates(), this.snapTradeInstance.GetAccountBalance()])
   const conversation = [
  { 
    role: "system", 
