...
export class Debate {
  ...
  async beginDebate(briefing, context, remainingTrades) {
    ...
    // Detect exit-management debates (TRADE AROUND, DEFENSIVE, AVERAGE_DOWN).
    // These are portfolio management decisions — Phi/Theta hard blocks designed for
    // new-entry signal quality are irrelevant and actively misleading for SELL orders.
