...
export class Debate {
  ...
  async beginDebate(briefing, context) {
    ...
    console.log(`Our Account: ${portfolio} | Our Holdings: ${accountHoldings} | Our Buying Power: ${buyingPower} USD | Our Account Total Value: ${totalValue} USD | Last Orders (24h): ${orders24h} ` )
